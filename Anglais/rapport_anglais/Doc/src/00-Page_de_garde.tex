\begin{titlepage}
  ...
  \Large
  Student : Cyprien \textsc{QUIVET}\\ % Your name
   \Large
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{img/projet.png}\\% Include a department/university logo - this will require the graphicx package
    \label{fig:LogoTachyssema}
  \end{figure}
